...
<section id="main" class="container">
	...
	<div class="row">
		...
		<!-- Text -->
			<section class="box">
				<center><h2>Estadisticas de atencion de pacientes por servicio ANUAL</h2></center>
			...
			<section class="box">
				<center><h2>Estadisticas de atencion de pacientes por servicio MENSUAL</h2></center>
				<form action="" method="post" accept-charset="utf-8">
