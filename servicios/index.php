...
$sql1 = "SELECT count(*) AS cuantos FROM servicio;";
$cantidad = $u->GetDatosSql($sql1);
$sql2 = "SELECT * FROM servicio LIMIT ".$empezar_desde.",".$cant_por_pagina." ";
						...
						<table class="alt">
							...
							<tbody>
								...
								foreach($datos as $dato){
									$cont++;
									$enc = $u->encriptar($dato->id_servicio);
									?>
									<tr>
										<td><?php echo $cont ?></td>
