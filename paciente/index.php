...
$sql2 = "select pe.* from paciente as pa, persona as pe where pa.ci = pe.ci
...
<html>
	...
	<body>
		...
		a = <?php echo $_GET["m"];?>;
		if(a == 1){
			alertify.success('Los datos del paciente han sido agregados correctamente.');
		}
		if(a == 2){
			alertify.success('Los datos del paciente han sido modificados correctamente.');
		}
		</script>
		<div id="page-wrapper">
