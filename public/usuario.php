...
class usuario extends Conectar{
	...
	public function insertarPaciente(){
		...
		$this->db->query($sql);
		$sql = "insert into paciente values (null,CURRENT_DATE(),'".$_POST["ci"]."')";
		$this->db->query($sql);
	}
	...
	public function insertarHistoria(){
		$sql = "insert into registrahistoria values (null, '".$_POST["motivo"]."', CURRENT_DATE(), '".$_POST["procedencia"]."', '".$_POST["lugar"]."', '".$_POST["dosis"]."', '".$_SESSION["id_enf"]."','".$_POST["id_pac"]."','".$_POST["servicio"]."')";
		$this->db->query($sql);
	}
